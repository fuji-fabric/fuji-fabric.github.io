...
## Commands
:::command
- Command Syntax: `/rtp [RtpDimension dimension]`
...
:::
:::command
- Command Syntax: `/rtp others <PlayerCollection others> [RtpDimension dimension]`
- Document:   Random rtp in specified dimension.
...
## Argument Types
:::argument-type
- Argument Type Name: `[rtp-dimension]`
- Argument Type Class: `[RtpDimension]`
:::
